...
out_dir = r'D:\kaifa-teacher\moneyprinter\agent-video\qa\verify_v11'
...
print('scene          time   yellow_R  title_R   title_L')
print('-' * 60)
for r in results:
    print('{:<14} {:<6} {:<9} {:<9} {}'.format(r['scene'], r['time'], r['yellow_right'], r['title_right'], r['title_left']))

overflow = [r['scene'] for r in results if r['yellow_right'] == 'YES' or r['title_right'] == 'YES']
if overflow:
    print('\n[FAIL] still overflowing:', overflow)
else:
